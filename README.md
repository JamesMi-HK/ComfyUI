...
To fix [well-known](https://documentation.sigma2.no/jobs/mkl.html#forcing-mkl-to-use-best-performing-routines) performance degradation on AMD CPUs, additional setup is needed. Create a library that enables optimizations on AMD CPUs by running:
