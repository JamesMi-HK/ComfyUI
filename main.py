...
def cuda_malloc_warning():
    ...
    if "cudaMallocAsync" in device_name:
        ...
        if cuda_malloc_warning:
            print(
                "\nWARNING: this card most likely does not support cuda-malloc, if you get \"CUDA error\" please run "
                "ComfyUI with: --disable-cuda-malloc\n")
...
if __name__ == "__main__":
    ...
    # These are the default folders that checkpoints, clip and vae models will be saved to when using CheckpointSave,
    # etc.. nodes
